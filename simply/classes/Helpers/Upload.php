 ...
 *
 * - [\Helpers\Upload::$remove_spaces]
 * - [\Helpers\Upload::$default_directory]
 */
class Upload {
	 ...
	 *         \Helpers\Upload::save($array['file']);
	 *     }
	 *
	...
	public static function save(array $file, $filename = NULL, $directory = NULL, $chmod = 0644)
	{
		...
		{
			throw new \Core\Exception('Directory :dir must be writable',
				array(':dir' => \Core\Debug::path($directory)));
		}
	 ...
	 * _do_ require a file to be uploaded, add the [\Helpers\Upload::not_empty] rule
	 * before this rule.
	 *
	 *     $array->rule('file', '\Helpers\Upload::valid')
	 *
	 ...
	 *
	 *     $array->rule('file', '\Helpers\Upload::not_empty');
	 *
	 * @param   array   $file   $_FILES item
	 * @return  bool
	 */
	 ...
	 *
	 *     $array->rule('file', '\Helpers\Upload::type', array(':value', array('jpg', 'png', 'gif')));
	 *
	 * @param   array   $file       $_FILES item
	 ...
	 * defined in \Helpers\Num::$byte_units
	 *
	 *     $array->rule('file', '\Helpers\Upload::size', array(':value', '1M'))
	 *     $array->rule('file', '\Helpers\Upload::size', array(':value', '2.5KiB'))
	 *
	 * @param   array   $file   $_FILES item
	 ...
	 *     $array->rule('image', '\Helpers\Upload::image')
	 *
	 *     // The "photo" file has a maximum size of 640x480 pixels
	 *     $array->rule('photo', '\Helpers\Upload::image', array(':value', 640, 480));
	 *
	 *     // The "image" file must be exactly 100x100 pixels
	 *     $array->rule('image', '\Helpers\Upload::image', array(':value', 100, 100, TRUE));
	 *
	 *
	 * @param   array   $file       $_FILES item
