...
class Valid {
	...
	{
		return \Helpers\UTF8::strlen($value) >= $length;
	}
	...
	public static function exact_length($value, $length)
	{
		if (is_array($length))
		{
			...
			{
				if (\Helpers\UTF8::strlen($value) === $strlen)
				{
					return TRUE;
				}
			}
	...
	{
		if (\Helpers\UTF8::strlen($email) > 254)
		{
			return FALSE;
		}
	...
	public static function credit_card($number, $type = NULL)
	{
		...
		$cards = \Simply::$config->load('credit_cards');
