...
class Date {
	...
	// Available formats for static::months()
	const MONTHS_LONG  = '%B';
	 ...
	 *
	 *     $seconds = \Helpers\Date::offset('America/Chicago', 'GMT');
	 *
	 ...
	 *
	 *     $seconds = \Helpers\Date::seconds(); // 01, 02, 03, ..., 58, 59, 60
	 *
	 ...
	 *
	 *     $minutes = \Helpers\Date::minutes(); // 05, 10, 15, ..., 50, 55, 60
	 *
	 * @uses    static::seconds
	 * @param   integer $step   amount to increment each step by, 1 to 30
	 * @return  array   A mirrored (foo => foo) array from 1-60.
	 ...
	 *
	 *     $hours = \Helpers\Date::hours(); // 01, 02, 03, ..., 10, 11, 12
	 *
	 ...
	 *
	 *     $type = \Helpers\Date::ampm(12); // PM
	 *     $type = \Helpers\Date::ampm(1);  // AM
	 *
	 ...
	 *
	 *     $hour = \Helpers\Date::adjust(3, 'pm'); // 15
	 *
	 ...
	 *
	 *     \Helpers\Date::days(4, 2010); // 1, 2, 3, ..., 28, 29, 30
	 *
	 ...
	 *
	 * But you can customise this by passing in either static::MONTHS_LONG
	 *
	 *     \Helpers\Date::months(static::MONTHS_LONG);
	 *     // array(1 => 'January', 2 => 'February', ..., 12 => 'December')
	 *
	 * Or static::MONTHS_SHORT
	 *
	 *     \Helpers\Date::months(static::MONTHS_SHORT);
	 ...
	 *
	 *     $years = \Helpers\Date::years(2000, 2010); // 2000, 2001, ..., 2009, 2010
	 *
	 ...
	 * Also consider using [\Helpers\Date::fuzzy_span] when displaying a span.
	 *
	 *     $span = \Helpers\Date::span(60, 182, 'minutes,seconds'); // array('minutes' => 2, 'seconds' => 2)
	 *     $span = \Helpers\Date::span(60, 182, 'minutes'); // 2
	 *
	 ...
	 *
	 *     $span = \Helpers\Date::fuzzy_span(time() - 10); // "moments ago"
	 *     $span = \Helpers\Date::fuzzy_span(time() + 20); // "in moments"
	 *
	 ...
	 * Converting the other direction is done using {@link static::dos2unix}.
	 *
	 *     $dos = \Helpers\Date::unix2dos($unix);
	 *
	 ...
	 * this is needed, but some binary formats use it (eg: zip files.)
	 * Converting the other direction is done using {@link static::unix2dos}.
	 *
	 *     $unix = \Helpers\Date::dos2unix($dos);
	 *
	 ...
	 *
	 *     $time = \Helpers\Date::formatted_time('5 minutes ago');
	 *
