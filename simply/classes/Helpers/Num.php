...
class Num {
	 ...
	 *
	 *     echo 2, \Helpers\Num::ordinal(2);   // "2nd"
	 *     echo 10, \Helpers\Num::ordinal(10); // "10th"
	 *     echo 33, \Helpers\Num::ordinal(33); // "33rd"
	 *
	 ...
	 *     echo \Helpers\Num::format(1200.05, 2);
	 *
	 *     // In English, "1,200.05"
	 *     // In Spanish, "1.200,05"
	 *     // In Portuguese, "1.200.05"
	 *     echo \Helpers\Num::format(1200.05, 2, TRUE);
	 *
	 ...
	 */
	public static function round($value, $precision = 0, $mode = static::ROUND_HALF_UP, $native = TRUE)
	{
	 ...
	 * \Helpers\Num::$byte_units
	 *
	 *     echo \Helpers\Num::bytes('200K');  // 204800
	 *     echo \Helpers\Num::bytes('5MiB');  // 5242880
	 *     echo \Helpers\Num::bytes('1000');  // 1000
	 *     echo \Helpers\Num::bytes('2.5GB'); // 2684354560
	 *
	...
	public static function bytes($size)
	{
		...
		$unit = \Helpers\Arr::get($matches, 2, 'B');
